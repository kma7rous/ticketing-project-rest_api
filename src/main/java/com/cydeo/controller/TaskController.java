...
public class TaskController {
    ...
    public ResponseEntity<ResponseWrapper> getTasks() {
        ...
        return ResponseEntity.ok(new ResponseWrapper("Projects are successfully retrieved", taskDTOList, HttpStatus.OK));
    }
    ...
    public ResponseEntity<ResponseWrapper> getTaskById(@PathVariable("taskId") Long taskId) {
        ...
        return ResponseEntity.ok(new ResponseWrapper("Projects are successfully retrieved", taskDTO, HttpStatus.OK));
    }
    ...
    public ResponseEntity<ResponseWrapper> employeePendingTasks(){
        ...
        return ResponseEntity.ok(new ResponseWrapper("Task is successfully completed", taskDTOList, HttpStatus.OK));
    }
